...
class StatComponentWidget extends StatefulWidget {
  const StatComponentWidget({
    ...
    required this.completadasConRetraso,
    required this.sinCompletar,
  });

  final String? titulo;
  final String? prioridad;
  final int? completadasATiempo;
  final int? completadasConRetraso;
  final int? sinCompletar;
