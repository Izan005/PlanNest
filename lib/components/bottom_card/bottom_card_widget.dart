...
import 'bottom_card_model.dart';
export 'bottom_card_model.dart';
...
class _BottomCardWidgetState extends State<BottomCardWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BottomCardModel());
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Opacity(
                                    opacity:
                                        _model.prioridad == 'media' ? 1.0 : 0.5,
                                    child: FFButtonWidget(
                                      onPressed: () async {
