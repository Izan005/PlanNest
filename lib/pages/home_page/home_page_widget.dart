                            ...
                            child: Stack(
                              children: [
                                Column(
                                  ...
                                  children: [
                                    if ((_model.tareasUser.isNotEmpty) == false)
                                      Expanded(
                                        child: Opacity(
                                          opacity: 0.5,
                                          child: Align(
                                    ...
                                    if ((_model.tareasUser.isNotEmpty) == true)
                                      Expanded(
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      if ((_model.notasUser.isNotEmpty) == true)
                                        Expanded(
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
