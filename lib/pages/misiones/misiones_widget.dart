...
class _MisionesWidgetState extends State<MisionesWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MisionesModel());
                                            ...
                                            Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      0.0, 10.0, 0.0, 0.0),
                                              child: Text(
                                                'Completa 2 tareas de prioridad baja',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 10.0, 0.0, 0.0),
                                      child: Text(
                                        'Completa 2 tareas de prioridad alta',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inter(
                                        ...
                                        child: Align(
                                          ...
                                          child: LinearPercentIndicator(
                                            ...
                                            progressColor:
                                                FlutterFlowTheme.of(context)
                                                    .error,
                                            backgroundColor: Color(0x34C9CBCD),
                                      ...
                                      Expanded(
                                        child: Align(
                                          ...
                                          child: LinearPercentIndicator(
                                            ...
                                            animation: true,
                                            animateFromLastPercent: true,
                                            progressColor: Color(0xFF8AD2FF),
                                            backgroundColor: Color(0x34C9CBCD),
                                            barRadius: Radius.circular(12.0),
                                            padding: EdgeInsets.zero,
                                          ),
